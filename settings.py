...
SECRET_KEY = 'django-insecure-$-7#x7h+&@d#dn$rt7@hd504hg!_-75yu@aixq(v($y02f^=0v'
...
AUTH_USER_MODEL = "recruiter.CustomUser"  # Set custom user model
AUTHENTICATION_BACKENDS = [
    'django.contrib.auth.backends.ModelBackend',
    'recruiter.backends.EmailBackend',  # ✅ Custom backend for email
]
...
ADMINS = [('dnajmy', 'dnajmy25@gmail.com')]  # Replace with real admin emails
